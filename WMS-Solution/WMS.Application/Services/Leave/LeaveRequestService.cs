...
public class LeaveRequestService : ILeaveRequestService
{
    ...
    public async Task<IEnumerable<LeaveRequestDto>> GetLeavesByEmployeeId(int employeeId)
    {
        var leaves = await _leaveRequestRepository.GetLeavesByEmployeeId( employeeId);
